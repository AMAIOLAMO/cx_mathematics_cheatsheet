...
\usepackage{anysize}
\marginsize{3em}{3em}{2em}{3em} % page margins, left, right, top, bottom
...
The following image uses a \textbf{Right-hand Coordinate System}:
\begin{center}
    \includegraphics[width=10em, height=10em]{vector_cross_product_righthanded}
\end{center}
