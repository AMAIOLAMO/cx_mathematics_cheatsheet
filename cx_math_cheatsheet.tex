...
\sgap
\textbf{Logarithm and Exponential} of quaternions:

If we let $\alpha = \frac{\theta}{2}$, then we can define the logarithm of a versor $Q$ as:
\begin{center}
    $log(Q) = log(\begin{bmatrix}cos~\alpha & sin~\alpha~\hat{n}\end{bmatrix}) = \begin{bmatrix}0 & \alpha\hat{n}\end{bmatrix}$
\end{center}
...
\sgap
If a quaternion has the format $Q = \begin{bmatrix}0 & \alpha\hat{n}\end{bmatrix}$ then we can define the exponential of it as:
\begin{center}
    $exp(Q) = exp(\begin{bmatrix}0 & \alpha\hat{n}\end{bmatrix}) = \begin{bmatrix}cos~\alpha & sin~\alpha~\hat{n}\end{bmatrix}$
\end{center}
